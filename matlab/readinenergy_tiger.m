function [t,ke,gpe,dissipation] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [T,KE,GPE,DISSIPATION] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [T,KE,GPE,DISSIPATION] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [t,ke,gpe,dissipation] = importfile('budgetWaterwind.dat',2, 50235);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/02/14 13:33:05
