function field = readinfield(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FIELD = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   FIELD = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   field = importfile('fieldnl5', 2, 1090);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/12 11:30:13
