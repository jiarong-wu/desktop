function [y,U] = readinvelocity(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [Y,U0] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   [Y,U0] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [y,U0] = importfile('velocity_0.dat',2, 33);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/09/05 20:14:18
